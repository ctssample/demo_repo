DROP TABLE IF EXISTS ${env}_swe_raw.${raw_table_gprs};

CREATE EXTERNAL TABLE ${env}_swe_raw.${raw_table_gprs}
(
...
COMMENT 'Temporary table for RiO FC GPRS feed'
ROW FORMAT DELIMITED FIELDS TERMINATED BY '`'
LOCATION '${hdfs_raw_dir_gprs}';
