DROP TABLE IF EXISTS ${env}_swe_base.T_RIO_PRAG_INCOMING_GSM;

CREATE TABLE ${env}_swe_base.T_RIO_PRAG_INCOMING_GSM
(
...
COMMENT 'Base table for RiO prage incoming GSM feed' 
PARTITIONED BY(schdate_year string, schdate_month string, schdate_day string , schtime_hour string)
stored as AVRO
LOCATION '${nameNode}/data/${env}/swe/base/rio/rio_prag_incoming_gsm/';
